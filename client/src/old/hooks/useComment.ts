...
import { createComment, deleteComment, editComment, getComments, likeComment } from "@/old/api/requests/comment";
import { CommentFormSchema } from "@/old/schema/comment.schema";
