...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/old/components/ui/tabs"
...
const Profile = () => {
    ...
    const isLoading = userLoading || postsLoading || followingsLoading;
    const hasError = userError || postsError || followingsError;
